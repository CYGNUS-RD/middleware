    ...
    while True:
        try:
            ...
            for bank_name, bank in event.banks.items():
                ...
                if bank_name=='DGH0': 
                    waveform_header = cy.daq_dgz_full2header(bank)
                    if verbose: print (waveform_header)
                    waveform_fast, waveform_slow = cy.daq_dgz_full2array(event.banks['DIG0'], waveform_header)  #,corrected=corrected,ch_offset=channels_offset

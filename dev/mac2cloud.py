...
def main():
    ...
    #
    TAG         = "WC"
    INAPATH     = "/Volumes/Users/Public/WC-TEST/"
    DAQPATH     = "/Users/mazzitel/Dropbox/GR2/soft/"
    ...
    parser.add_option('-s','--session', dest='session', type='string', default='infncloud-iam', help='session [infncloud-iam]')
    ...
    while True:
        ...
        try: 
            ...
            for i in range(0, np.size(file_in_dir)): #
                if ('.trc' in str(file_in_dir[i])) and (not file_in_dir[i].startswith('.')):

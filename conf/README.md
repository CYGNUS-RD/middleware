...
- 131.154.99.172  grafana CLOUD-CNAF-T1 **up and running** (9000 port for localhost phpadmin)
...
- editor/notebook
```
docker run -it -d -p 8888:8888 --name editor --user root -w /home/jovyan/work -v $(pwd):/home/jovyan/work jupyter/minimal-notebook
